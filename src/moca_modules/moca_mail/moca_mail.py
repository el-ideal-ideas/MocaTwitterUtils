...
class MocaMail:
    ...
    async def send_aio_mail(self, to_address: List[str], body: str, title: str, mail_type: str = 'plain') -> None:
        """
        Send a mail.
        :param to_address: the to address.
        :param body: the body of the email.
    ...
    def send_mail(self, to_address: List[str], body: str, title: str, mail_type: str = 'plain') -> None:
        """
        Send a mail.
        :param to_address: the to address.
        :param body: the body of the email.
